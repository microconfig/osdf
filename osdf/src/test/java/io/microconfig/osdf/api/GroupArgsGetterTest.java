...
class GroupArgsGetterTest {
    ...
    private Method getMethodWithSecondOptional() throws NoSuchMethodException {
        return GroupArgsGetterTest.class.getDeclaredMethod("methodWithSecondOptional", String.class, List.class, String.class);
    }

    private Method getMethodWithSecondRequired() throws NoSuchMethodException {
        return GroupArgsGetterTest.class.getDeclaredMethod("methodWithSecondRequired", String.class, List.class, String.class);
    }

    private Method getMethodWithoutSecond() throws NoSuchMethodException {
        return GroupArgsGetterTest.class.getDeclaredMethod("methodWithoutSecond", String.class, List.class);
    }
}